...
hpo_term_search = function(term_id) {
  ...
  enframe() |> 
  spread(name, value) |> 
  select(name, id, altTermIds, definition, comment, 
         synonyms, isObsolete, xrefs, pubmedXrefs)
...
The output produces a list with four tibbles: term details; relations, i.e., the parent and/or child terms associated; genes associated; and diseases associated. Here are an example of these results:
