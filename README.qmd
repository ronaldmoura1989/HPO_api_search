...
::: callout-note
On June 2024, HPO decided to close this API endpoint. Go to the RSelenium functions (topic 3) to find an alternative. :)
:::
...
::: callout-note
We choose to use Firefox as engine. Therefore, you need to have this browser installed. Also, it is recommended to install [geckodriver](https://github.com/mozilla/geckodriver/releases) and attach it to the PATH.
:::
